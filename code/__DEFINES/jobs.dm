...
#define JOB_CWU_DIRECTOR "CWU Director"
#define JOB_DISPATCH "Dispatch"
#define JOB_CIVIL_PROTECTION "Civil Protection"
#define JOB_CITY_ADMINISTRATOR "City Administrator"
#define JOB_CWU_MEMBER "CWU Member"
#define JOB_CWU_MEDIC "CWU Medic"

//hl13 display order
#define JOB_DISPLAY_ORDER_JOB_CITIZEN 36
#define JOB_DISPLAY_ORDER_CIVIL_PROTECTION_COMMANDER 37
#define JOB_DISPLAY_ORDER_CWU_DIRECTOR 38
#define JOB_DISPLAY_ORDER_DISPATCH 39
#define JOB_DISPLAY_ORDER_CIVIL_PROTECTION 40
#define JOB_DISPLAY_ORDER_CITY_ADMINISTRATOR 41
#define JOB_DISPLAY_ORDER_CWU_MEMBER 42
#define JOB_DISPLAY_ORDER_CWU_MEDIC 43

//hl13 departments
#define DEPARTMENT_BITFLAG_CIVIL_PROTECTION (1<<0)
#define DEPARTMENT_CIVIL_PROTECTION "CivilProtection"
#define DEPARTMENT_BITFLAG_CIVIL_WORKERS_UNION (1<<8)
#define DEPARTMENT_CIVIL_WORKERS_UNION "CivilWorkersUnion"
#define DEPARTMENT_ADMINISTRATION "TheAdministration"
#define DEPARTMENT_BITFLAG_ADMINISTRATION (1<<1)
#define DEPARTMENT_BITFLAG_TRANSHUMAN (1<<3)
#define DEPARTMENT_TRANSHUMAN "TranshumanOverwatch"
#define DEPARTMENT_BITFLAG_RESISTANCE (1<<3)
#define DEPARTMENT_RESISTANCE "Resistance"