...
#define MAX_S_TURF SMOOTH_GROUP_TURF_COBBLESTONE_ROAD //Always set this as the last one of this list
//HL13 CODE ENDS HERE
...
//HL13 CODE STARTS HERE (unfortunatly you cant change definers in other files so you must stick to this)
#define SMOOTH_GROUP_TRAIN_WALLS S_OBJ(72)

#undef MAX_S_OBJ //Undefining vanilla MAX_S_OBJ
#define MAX_S_OBJ SMOOTH_GROUP_TRAIN_WALLS //Always set this as the last one of this list
//HL13 CODE ENDS HERE
