/obj/item/clothing/head/helmet/hl13/
	icon = 'hl13/icons/obj/clothing/helmets.dmi'
	worn_icon = 'hl13/icons/mob/clothing/helmets.dmi'
	flags_inv = HIDEEARS|HIDENECK|HIDEHAIR
